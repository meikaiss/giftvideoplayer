...
public class TopColorBottomAlphaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        giftVideoView.setAlphaMode(AlphaMode.TopColorBottomAlpha);
        ...
        giftVideoView.setOnVideoEndedListener(new GiftVideoView.OnVideoEndedListener() {
            ...
            public void onVideoEnded() {
                ...
                ((ViewGroup)giftVideoView.getParent()).removeView(giftVideoView);
            }
        });
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_bg_black:
                ...
                break;
            case R.id.btn_start:
                giftVideoView.setVideoFromAssets("topColorBottomAlpha_1.mp4");
                break;
            case R.id.btn_hide:
